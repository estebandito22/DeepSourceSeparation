...
from dss.trainers.mhunet import MHUNet
...
if __name__ == '__main__':
    ...
    # train_datasets = [BandhubDataset(df, 'train', c) for c in classes]
    # val_datasets = [BandhubDataset(df, 'val', c, False, random_seed=0)
    #                 for c in classes]
    train_dataset = BandhubDataset(df, 'train')
    val_dataset = BandhubDataset(df, 'val', random_seed=0)
    ...
    unet = MHUNet(n_classes=len(classes),
    ...
    unet.fit(train_dataset, val_dataset, train_predset, val_predset,
