...
class MHUNet(SourceSeparator):
    ...
    def fit(self, train_dataset, val_dataset, train_predset, val_predset,
            save_dir, pretrained_state=None):
        """
        Train the NN model.
        ...
        print("Settings:\n\
               ...
               Save Dir: {}".format(
                   ...
                   self.weight_decay, self.objective, bool(pretrained_state),
                   save_dir), flush=True)
    ...
    def _format_model_subdir(self):
        subdir = "MHUNet_nc{}sl{}ic{}ns{}do{}lr{}wd{}ob{}pt{}".\
                format(self.n_classes, self.n_shared_layers, self.in_channels,
                       self.negative_slope, self.dropout, self.lr,
                       self.weight_decay, self.objective, self.pretrained)
        return subdir
